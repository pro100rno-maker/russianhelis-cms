...
const dependencies = {
  ...
  "@strapi/icons": "1.19.0",
  "@strapi/provider-upload-local": "4.25.22",
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      async Component() {
        const component = await import("./index-ymhMKzl6.mjs");
        return component;
      }
    });
  ...
  bootstrap(app) {
    app.addSettingsLink("global", {
      ...
      async Component() {
        const component = await import("./index-_gC-H8De.mjs");
        return component;
      },
  ...
  async registerTrads({ locales }) {
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/ca.json": () => import("./ca-EiEoG96a.mjs"), "./translations/de.json": () => import("./de-CEO1wNhl.mjs"), "./translations/dk.json": () => import("./dk-Judjxeox.mjs"), "./translations/en.json": () => import("./en-Q6nIM8GZ.mjs"), "./translations/es.json": () => import("./es-64knIPhK.mjs"), "./translations/fr.json": () => import("./fr-M0bxmaOq.mjs"), "./translations/he.json": () => import("./he-_fSaX9rS.mjs"), "./translations/hr.json": () => import("./hr-5Y0enNIB.mjs"), "./translations/it.json": () => import("./it-G91O8vsJ.mjs"), "./translations/ja.json": () => import("./ja-XQwSRd0U.mjs"), "./translations/ko.json": () => import("./ko-dH9q_Ivi.mjs"), "./translations/ms.json": () => import("./ms-cJhKTqZ1.mjs"), "./translations/pl.json": () => import("./pl-PGx8jRyO.mjs"), "./translations/pt-BR.json": () => import("./pt-BR-kotPmwXm.mjs"), "./translations/pt.json": () => import("./pt-h5YyM5q5.mjs"), "./translations/ru.json": () => import("./ru-YHGnfUOQ.mjs"), "./translations/sk.json": () => import("./sk-JYYgDOpb.mjs"), "./translations/th.json": () => import("./th-8DzOZ1N_.mjs"), "./translations/tr.json": () => import("./tr-BJx1RKAN.mjs"), "./translations/uk.json": () => import("./uk-TAkZuqhF.mjs"), "./translations/zh-Hans.json": () => import("./zh-Hans-gue_fPye.mjs"), "./translations/zh.json": () => import("./zh-nyfS9-tF.mjs") }), `./translations/${locale}.json`).then(({ default: data }) => {
          return {
...
//# sourceMappingURL=index-EumNBdBa.mjs.map
