      ...
      /* @__PURE__ */ jsx(
        ActionLayout,
        {
          ...
          endActions: /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx(CheckPermissions, { permissions: PERMISSIONS.configureView, children: /* @__PURE__ */ jsx(ActionContainer, { children: /* @__PURE__ */ jsx(
              IconButton,
              {
                forwardedAs: Link$1,
                to: {
            ...
            /* @__PURE__ */ jsx(ActionContainer, { children: /* @__PURE__ */ jsx(
              IconButton,
              {
...
const ConfigureTheView = lazy(() => import("./index-cQ1UWdta.mjs"));
const Upload = () => {
  const {
...
//# sourceMappingURL=index-ymhMKzl6.mjs.map
