...
const useWebhooks = require("./useWebhooks-rUXZtGhD.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-LXrDlBfr.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-IqschOA1.js.map
