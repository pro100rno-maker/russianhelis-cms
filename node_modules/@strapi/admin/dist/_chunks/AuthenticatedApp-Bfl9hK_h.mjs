...
import { u as useConfiguration, a as useAuth, c as createTypedSelector, b as useOnce, d as createRoute, e as useInformationQuery, f as useGetMyPermissionsQuery, R as RBACProvider, N as NpsSurvey } from "./index-5hP8C9h_.mjs";
...
const dependencies = {
  ...
  "@strapi/icons": "1.19.0",
  "@strapi/permissions": "4.25.22",
  "@strapi/provider-audit-logs-local": "4.25.22",
...
const devDependencies = {
  "@strapi/admin-test-utils": "4.25.22",
  "@strapi/data-transfer": "4.25.22",
  "@strapi/pack-up": "4.23.0",
  "@strapi/plugin-content-manager": "4.25.22",
...
const CM = React.lazy(
  () => import("./index-5hP8C9h_.mjs").then((n) => n.a0).then((mod) => ({ default: mod.App }))
);
const HomePage = React.lazy(
  () => import("./HomePage-eu--l8xF.mjs").then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React.lazy(
  () => import("./InstalledPluginsPage-bwx1FfBD.mjs").then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React.lazy(
  () => import("./MarketplacePage-gM6Owfe4.mjs").then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React.lazy(
  () => import("./index-5hP8C9h_.mjs").then((n) => n.$).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React.lazy(
  () => import("./ProfilePage-1wRz5NN3.mjs").then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React.lazy(
  () => import("./SettingsPage-Leij7RZb.mjs").then((mod) => ({
...
//# sourceMappingURL=AuthenticatedApp-Bfl9hK_h.mjs.map
