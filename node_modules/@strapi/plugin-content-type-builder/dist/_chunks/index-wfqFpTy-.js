...
const index$1 = require("./index-UBNvupQB.js");
...
const ListView$1 = React.lazy(() => Promise.resolve().then(() => require("./ListView-6QqWBlov.js")));
const RecursivePath = () => {
...
const ListView = React.lazy(() => Promise.resolve().then(() => require("./ListView-6QqWBlov.js")));
const App = () => {
  const { formatMessage } = reactIntl.useIntl();
...
//# sourceMappingURL=index-wfqFpTy-.js.map
