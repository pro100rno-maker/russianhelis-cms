...
const ListView$1 = lazy(() => import("./ListView-y5EjvP_T.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-y5EjvP_T.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-1uNC-vsN.mjs.map
